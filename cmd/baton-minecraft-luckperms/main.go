...
import (
	...
	"github.com/conductorone/baton-minecraft-luckperms/pkg/connector"
...
func main() {
	...
	_, cmd, err := config.DefineConfiguration(
		...
		getConnector[*cfg.MinecraftLuckperms],
		cfg.Config,
	)
	if err != nil {
...
func getConnector[T field.Configurable](ctx context.Context, config *cfg.MinecraftLuckperms) (types.ConnectorServer, error) {
