...
ifeq ($(GOOS),windows)
OUTPUT_PATH = ${BUILD_DIR}/baton-minecraft-luckperms.exe
else
OUTPUT_PATH = ${BUILD_DIR}/baton-minecraft-luckperms
endif
...
build: ${GENERATED_CONF}
	go build ${BUILD_TAGS} -o ${OUTPUT_PATH} ./cmd/baton-minecraft-luckperms
